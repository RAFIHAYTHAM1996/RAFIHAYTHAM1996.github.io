  ...
  _createClass(TermsOfUse, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_main.default, {
        ...
        className: "dark padding"
      }, "Contents"), _react.default.createElement("ol", null, this.sections.map(function (section) {
        var renderLink = function renderLink(title) {
        ...
        if (typeof section === 'string') {
          ...
          var result = section[1].map(function (sec) {
            return _react.default.createElement(_react.Fragment, null, renderLink(sec), _react.default.createElement("br", null));
          });
...
//# sourceMappingURL=terms-of-use.js.85cad3f06ad098e3ec2c.hot-update.js.map
