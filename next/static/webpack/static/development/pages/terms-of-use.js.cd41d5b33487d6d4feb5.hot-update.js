...
function (_Component) {
  ...
  function TermsOfUse(props) {
    ...
    _this.sections = ['YOUR ACCEPTANCE OF THIS AGREEMENT', 'CHANGES TO THIS AGREEMENT', 'PERMITTED USERS AND ACCESS', 'MISPRINTS AND ERRORS, PRICES AND PURCHASES', 'NO ADVICE OR SOLICITATION', ['DISCLAIMER, LIABILITY EXCLUSION, LIABILITY LIMITATION, RELEASE AND INDEMNITY', ['6.DISCLAIMER', '6.LIABILITY EXCLUSION', '6.LIMITATION OF LIABILITY', '6.RELEASE', '6.INDEMNITY']], 'LOGIN NAMES AND PASSWORDS', 'TERMINATION OF THIS AGREEMENT AND THE WEB SITE', 'INFORMATION SUBMISSIONS', 'OWNERSHIP AND PERMITTED USE OF THE WEB SITE', 'PERSONAL INFORMATION PRIVACY', 'TRADE-MARK INFORMATION', 'OTHER SITES', 'LINKING AND FRAMING THE WEB SITE', 'POSTINGS AND UNSOLICITED SUBMISSIONS', 'GOVERNING LAW AND DISPUTE RESOLUTION', 'OTHER MATTERS'];
    return _this;
  }
  ...
  _createClass(TermsOfUse, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_main.default, {
        ...
        className: "dark padding"
      }, "Contents"), _react.default.createElement("ol", null, _react.default.createElement("li", null, "YOUR ACCEPTANCE OF THIS AGREEMENT"), _react.default.createElement("li", null, "CHANGES TO THIS AGREEMENT"), _react.default.createElement("li", null, "PERMITTED USERS AND ACCESS"), _react.default.createElement("li", null, "MISPRINTS AND ERRORS, PRICES AND PURCHASES"), _react.default.createElement("li", null, "NO ADVICE OR SOLICITATION"), _react.default.createElement("li", null, "DISCLAIMER, LIABILITY EXCLUSION, LIABILITY LIMITATION, RELEASE AND INDEMNITY", _react.default.createElement("br", null), _react.default.createElement("a", {
        className: "inline",
        href: ""
      }, "6.1 DISCLAIMER"), _react.default.createElement("br", null), _react.default.createElement("a", {
        className: "inline",
        href: ""
      }, "6.2 LIABILITY EXCLUSION"), _react.default.createElement("br", null), _react.default.createElement("a", {
        className: "inline",
        href: ""
      }, "6.3 LIMITATION OF LIABILITY"), _react.default.createElement("br", null), _react.default.createElement("a", {
        className: "inline",
        href: ""
      }, "6.4 RELEASE"), _react.default.createElement("br", null), _react.default.createElement("a", {
        className: "inline",
        href: ""
      }, "6.5 INDEMNITY")), _react.default.createElement("li", null), _react.default.createElement("li", null, "LOGIN NAMES AND PASSWORDS"), _react.default.createElement("li", null, "TERMINATION OF THIS AGREEMENT AND THE WEB SITE"), _react.default.createElement("li", null, "INFORMATION SUBMISSIONS"), _react.default.createElement("li", null, "OWNERSHIP AND PERMITTED USE OF THE WEB SITE"), _react.default.createElement("li", null, "PERSONAL INFORMATION PRIVACY"), _react.default.createElement("li", null, "TRADE-MARK INFORMATION"), _react.default.createElement("li", null, "OTHER SITES"), _react.default.createElement("li", null, "LINKING AND FRAMING THE WEB SITE"), _react.default.createElement("li", null, "POSTINGS AND UNSOLICITED SUBMISSIONS"), _react.default.createElement("li", null, "GOVERNING LAW AND DISPUTE RESOLUTION"), _react.default.createElement("li", null, "OTHER MATTERS")), _react.default.createElement("h5", {
        className: "dark padding"
...
//# sourceMappingURL=terms-of-use.js.cd41d5b33487d6d4feb5.hot-update.js.map
