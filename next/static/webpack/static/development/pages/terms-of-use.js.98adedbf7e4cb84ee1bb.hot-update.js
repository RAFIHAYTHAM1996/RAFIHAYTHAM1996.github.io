  ...
  _createClass(TermsOfUse, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_main.default, {
        ...
        console.log(section); // if (typeof section === 'string') return
        // <li><a className="inline" href={`#${makePath(section)}`}>{ section }</a></li>
...
//# sourceMappingURL=terms-of-use.js.98adedbf7e4cb84ee1bb.hot-update.js.map
