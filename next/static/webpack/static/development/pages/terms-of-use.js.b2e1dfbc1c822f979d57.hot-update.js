  ...
  _createClass(TermsOfUse, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_main.default, {
        ...
        className: "dark padding"
      }, "6.1 ", this.sections[5][1][0]), _react.default.createElement("h5", {
        id: (0, _makePath.default)(this.sections[5][1][1]),
        className: "dark padding"
      }, "6.2 ", this.sections[5][1][1]), _react.default.createElement("h5", {
        id: (0, _makePath.default)(this.sections[5][1][2]),
        className: "dark padding"
      }, "6.3 ", this.sections[5][1][2]), _react.default.createElement("h5", {
        id: (0, _makePath.default)(this.sections[5][1][3]),
        className: "dark padding"
      }, "6.4 ", this.sections[5][1][3]), _react.default.createElement("h5", {
        id: (0, _makePath.default)(this.sections[5][1][4]),
        className: "dark padding"
      }, "6.5 ", this.sections[5][1][4]), _react.default.createElement("h5", {
...
//# sourceMappingURL=terms-of-use.js.b2e1dfbc1c822f979d57.hot-update.js.map
