...
function (_Component) {
  ...
  _createClass(TermsOfUse, [{
    ...
    value: function render() {
      ...
      }), "Date of Last Update of this agreement: May 22, 2019 Please read this agreement carefully. It governs your use of the Hospall Private Home Care Inc. (\u201CHospall\u201D) web site located at www.hospall.com (the \u201CWeb Site\u201D) and the services and goods provided through the Web Site. It exempts Hospall and other persons from liability or limits their liability and contains other important provisions that you should read. Each time you use the Web Site you acknowledge and signify that you have read, understood, and agreed to be bound by this agreement. If you do not agree with each provision of this agreement each time you use the Web Site, you may not use the Web Site. The Web Site offers information, tools and resources to manage the care of persons with age-related and physically debilitating needs. Hospall does not provide medical advice through the Web Site or through any services offered on the Web Site. We are not a medical referral service and the Web Site does not provide medical referrals or make recommendations or endorsements for any healthcare providers. Each time you use the Web Site, the text of this agreement, as it then reads, will govern your use. Accordingly, when you use the Web Site you should check the date of this agreement and review any changes since the last time you visited. The changes will be clearly shown in the revised document for ease of reference. This agreement contains the following provisions:", _react.default.createElement("h5", {
        className: "dark padding"
...
//# sourceMappingURL=terms-of-use.js.6d7cb09b86aa7c027fb9.hot-update.js.map
