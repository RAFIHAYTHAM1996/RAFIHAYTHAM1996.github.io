  ...
  _createClass(TermsOfUse, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_main.default, {
        ...
        var renderLink = function renderLink(idText, title) {
          return _react.default.createElement("a", {
            className: "inline",
            href: "/terms-of-use#".concat((0, _makePath.default)(idText))
          }, title || idText);
        };
        ...
        if (typeof section === 'string') {
          ...
          var result = section[1].map(function (sec, idx) {
            return _react.default.createElement(_react.Fragment, null, renderLink(sec, "".concat(index + 1, ".").concat(idx + 1).concat(sec)), _react.default.createElement("br", null));
          });
...
//# sourceMappingURL=terms-of-use.js.27de84c1dab4b33ff8ec.hot-update.js.map
