    ...
    value: function render() {
      ...
      return _react.default.createElement(_main.default, {
        ...
        if (typeof section === 'string') {
          ...
          var result = renderLink(section[0]);
          result += section[1].slice(1).map(function (sec) {
            console.log(sec); // return renderLink(sec);
          });
          return result;
        }
...
//# sourceMappingURL=terms-of-use.js.3a3075ef2c908be4278a.hot-update.js.map
