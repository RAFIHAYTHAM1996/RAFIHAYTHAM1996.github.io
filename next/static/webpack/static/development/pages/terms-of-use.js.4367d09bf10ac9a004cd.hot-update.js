        ...
        if (typeof section === 'string') {
          ...
          var sublinks = section[1].map(function (sec, idx) {
            return _react.default.createElement("span", {
              key: sec + idx
            }, renderLink(sec, "".concat(index + 1, ".").concat(idx + 1)), _react.default.createElement("br", null));
          });
          return _react.default.createElement(_react.Fragment, null, _react.default.createElement("li", {
            key: section + index
          }, renderLink(section[0])), sublinks, _react.default.createElement("br", null));
        }
...
//# sourceMappingURL=terms-of-use.js.4367d09bf10ac9a004cd.hot-update.js.map
