      ...
      if (!emailState.submitted) {
        ...
        for (var i = 0; i < _this.InputFields.length; i++) {
          if (!_this.InputFields[i].state.valid) {
            emailState.formError = "Please fill out '".concat(_this.InputFields[i].props.label, "' field");
            valid = false;
            break;
          }
        }
        ...
        if (valid) {
          ...
          _axios.default.post((0, _urlJoin.default)(_settings.default.server, 'forms', 'careers.php'), _this.getFormContent(), {
            ...
            emailState.submitted = false; // console.log(error);
...
//# sourceMappingURL=careers.js.36bf361c3711b0f515e9.hot-update.js.map
