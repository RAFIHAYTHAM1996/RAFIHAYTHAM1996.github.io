  ...
  function JobApplication(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleScroll", function (e) {
      if (_this.container.getBoundingClientRect().top < window.innerHeight && !_this.state.analyticsSubmitted.scroll) {
        _reactGa.default.modalview('contact');
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleSubmit", function (e) {
      ...
      if (valid) {
        ...
        _axios.default.post("".concat(_settings.default.server, "careers.php"), _this.getFormContent(), {
          headers: {
          ...
          _reactGa.default.event({
            ...
            action: 'Submit',
            label: response.status === 200 ? 'Succeeded' : 'Failed'
          }); // if (settings.isDev) {
          //   document.open();
...
//# sourceMappingURL=careers.js.659e5b0721a188e2df42.hot-update.js.map