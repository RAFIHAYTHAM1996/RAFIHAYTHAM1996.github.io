      ...
      if (target.tagName === 'A') {
        ...
        if (href && href[0] === "#") {
          ...
          _gsap.TweenLite.to(window, 0.5, {
            scrollTo: window.pageYOffset + document.getElementById(href.substr(1)).getBoundingClientRect().top - 180,
      ...
      return _react.default.createElement(_main.default, {
        ...
        var renderLink = function renderLink(title, prefix) {
          return _react.default.createElement(_react.Fragment, null, prefix && _react.default.createElement("span", {
            key: section + index + '-span',
            style: {
              marginRight: 10,
              marginLeft: 10
            }
          }, prefix), _react.default.createElement("a", {
            key: section + index + 'asdasda',
            className: "inline",
        ...
        if (typeof section === 'string') {
          ...
          // let sublinks = section[1].map((sec, idx) => <span key={sec + idx}>{renderLink(sec, `${index+1}.${idx+1}`)}<br/></span> )
          return _react.default.createElement(_react.Fragment, null, _react.default.createElement("li", {
            key: section + index
          }, renderLink(section[0])), _react.default.createElement("br", null));
        }
...
//# sourceMappingURL=terms-of-use.js.747ad556d2496dc2498c.hot-update.js.map
