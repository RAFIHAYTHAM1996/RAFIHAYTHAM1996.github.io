...
function (_Component) {
  ...
  _createClass(TermsOfUse, [{
    ...
    value: function render() {
      ...
      }, "This agreement contains the following provisions:"), _react.default.createElement("ol", null, _react.default.createElement("li", null, "1 YOUR ACCEPTANCE OF THIS AGREEMENT"), _react.default.createElement("li", null, "CHANGES TO THIS AGREEMENT"), _react.default.createElement("li", null, "PERMITTED USERS AND ACCESS"), _react.default.createElement("li", null, "MISPRINTS AND ERRORS, PRICES AND PURCHASES"), _react.default.createElement("li", null, "NO ADVICE OR SOLICITATION"), _react.default.createElement("li", null, "DISCLAIMER, LIABILITY EXCLUSION, LIABILITY LIMITATION, RELEASE AND INDEMNITY"), _react.default.createElement("li", null, _react.default.createElement("ul", null, _react.default.createElement("li", null, "DISCLAIMER"), _react.default.createElement("li", null, "LIABILITY EXCLUSION"), _react.default.createElement("li", null, "LIMITATION OF LIABILITY"), _react.default.createElement("li", null, "RELEASE"), _react.default.createElement("li", null, "INDEMNITY"))), _react.default.createElement("li", null, "LOGIN NAMES AND PASSWORDS"), _react.default.createElement("li", null, "TERMINATION OF THIS AGREEMENT AND THE WEB SITE"), _react.default.createElement("li", null, "INFORMATION SUBMISSIONS"), _react.default.createElement("li", null, "OWNERSHIP AND PERMITTED USE OF THE WEB SITE"), _react.default.createElement("li", null, "PERSONAL INFORMATION PRIVACY"), _react.default.createElement("li", null, "TRADE-MARK INFORMATION"), _react.default.createElement("li", null, "OTHER SITES"), _react.default.createElement("li", null, "LINKING AND FRAMING THE WEB SITE"), _react.default.createElement("li", null, "POSTINGS AND UNSOLICITED SUBMISSIONS"), _react.default.createElement("li", null, "GOVERNING LAW AND DISPUTE RESOLUTION"), _react.default.createElement("li", null, "OTHER MATTERS")), _react.default.createElement("h5", {
        className: "dark padding"
...
//# sourceMappingURL=terms-of-use.js.e71459c7a3ee99a91c5c.hot-update.js.map
